        ...
        <div class="input-group">
          <input type="text" name="q" class="form-control" placeholder="Search...">
              <span class="input-group-btn">
                <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="icon iconastic-search"></i>
                </button>
              </span>
        </div>
      </form>
...
<!--
        <li class="active treeview">
          <a href="#">
            <i class="icon iconastic-tachometer"></i> <span>Dashboard</span> <i class="icon iconastic-angle-left pull-right"></i>
          </a>
          <ul class="treeview-menu">
            <li><a href="index.html"><i class="icon iconastic-android-radio-button-off"></i> Dashboard v1</a></li>
            <li class="active"><a href="index2.html"><i class="icon iconastic-android-radio-button-off"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
