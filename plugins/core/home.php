          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                <button type="button" class="btn btn-box-tool" data-widget="collapse"><i class="fa iconastic-minus"></i>
                </button>
                <div class="btn-group">
                  <button type="button" class="btn btn-box-tool dropdown-toggle" data-toggle="dropdown">
                    <i class="fa iconastic-wrench"></i></button>
                ...
                <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa iconastic-close"></i></button>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
