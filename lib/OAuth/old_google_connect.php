 ...
 */
	...
	$client->redirect_uri = 'http://'.$_SERVER['HTTP_HOST'].
        ...
        */
	$client->redirect_uri = 'http://www.brainarc.eu/';
	/* OAuth client identifier
	 * Set this to values defined by the OAuth server for your application
	 */
	$client->client_id = '1033436882515.apps.googleusercontent.com';

	/* OAuth client secret
	 * Set this to values defined by the OAuth server for your application
	 */
	$client->client_secret = 'CKSDoXuCYsgq5bOhFeOGgXF4';

	/* OAuth client permissions
	 * Set this to the name of the permissions you need to access the
	 * application API
	 */
	$client->scope = 'https://www.googleapis.com/auth/plus.me';
